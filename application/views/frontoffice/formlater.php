...
<head>
    ...
    <!-- Title Page-->
    <title>Reserver cette place</title>
                        ...
                        <div class="row">
								<div class="card">
                                    <div class="card-header">
                                        <strong>Reserver cette place</strong>
                                    </div>
                                    <div class="card-body card-block">
									<form action="<?php echo base_url('user/validlater') ?>" method="post" class="form-horizontal">
										
										<div class="row form-group">
											<div class="col-12 col-md-9">
												<input type="hidden" value="<?php if($error==null){echo $id;}else{echo set_value('id');}?>" 
												id="texinput" name="id" class="form-control">
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col col-md-3">
												<label for="textinput" class=" form-control-label">A partir du</label>
											</div>
											<div class="col-12 col-md-9">
												<input type="text" value="<?php if($error==null){echo $this->Time->getNow();}else{echo set_value('debut');}?>" 
												id="textinput" name="debut" class="form-control">
											</div>
										</div>

										<div class="row form-group">
											<div class="col col-md-3">
												<label for="text-input" class=" form-control-label">Pour</label>
											</div>
											<div class="col-12 col-md-9">
												<select type="text" id="text-input" name="duree" class="form-control">
