...
<head>
    ...
    <!-- Title Page-->
    <title>Quitter cette place</title>
                        ...
                        <div class="row">
								<div class="card">
                                    <div class="card-header">
                                        <strong>Quitter cette place</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url('welcome/quitter') ?>" method="post" class="form-horizontal">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="input" class=" form-control-label">Heure de depart</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php if($error==null){echo $this->Time->getNow();}else{echo set_value('fin');}?>" id="input" name="fin" class="form-control">
                                                </div>
                                            </div>
										...
										<p style="color:darkblue">Cliquer sur valider pour payer les <?=$amende?> ariary d'amendes.</p>
										<p style="color:darkblue">Durée d'infraction = <?=$tempsinfraction?> minutes.</p>
