...
<head>
    ...
    <!-- Title Page-->
    <title>Simuler l'état des places</title>
                        ...
                        <div class="row">
								<div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url('admin/simuler') ?>" method="post" class="form-horizontal">
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Date et Heure de simulation</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" value="<?php echo $this->Time->getNow();?>" id="text-input" name="simul" class="form-control">
                                                </div>
                                            </div>

                                            <button type="submit" class="btn btn-primary btn-sm">
                                                <i class="fa fa-dot-circle-o"></i> Simuler
                                            </button>
