...
<head>
    ...
    <!-- Title Page-->
    <title>Modification de tarif</title>
                        ...
                        <div class="row">
								<div class="card">
                                    <div class="card-header">
                                        <strong>Ajouter un tarif</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url('tarifcontroller/modifier') ?>" method="post" class="form-horizontal">
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Id</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="hidden" value="<?=$id?>" id="text-input" name="id" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" value="<?=$duree?>" id="text-input" name="duree" class="form-control">
                                                </div>
                                            </div>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" value="<?=$prix?>" id="text-input" name="prix" class="form-control">
