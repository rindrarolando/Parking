                        ...
                        <div class="row">
								<div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url('tarifcontroller/add') ?>" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" value="<?php echo set_value('duree')?>" id="text-input" name="duree" class="form-control">
                                                </div>
                                            </div>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" value="<?php echo set_value('prix')?>" id="text-input" name="prix" class="form-control">
